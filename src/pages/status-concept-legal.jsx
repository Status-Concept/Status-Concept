  ...
  privacy: {
    en: {
      ...
      sections: [
        ...
        ["Where it is stored", "Data is stored with our backend provider (Supabase). TODO: confirm hosting region and retention period with counsel."],
    ...
    pt: {
      ...
      sections: [
        ...
        ["Onde são guardados", "Os dados são guardados junto do nosso fornecedor de backend (Supabase). TODO: confirmar a região de alojamento e o período de retenção com aconselhamento jurídico."],
