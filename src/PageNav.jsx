    ...
    <div style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 9999, fontFamily: "'Outfit', sans-serif", display: 'flex', gap: 8, alignItems: 'flex-end' }}>
      ...
      <button
        ...
        style={{
          ...
          background: pathname === '/favorites' ? '#c41e3a' : 'var(--stone, #1a1a2e)',
      ...
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill={pathname === '/favorites' ? '#fff' : '#c41e3a'} stroke={pathname === '/favorites' ? '#fff' : '#c41e3a'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {menuPages.map(p => (
              <div
                ...
                style={{
                  ...
                  color: pathname === p.path ? '#c41e3a' : 'rgba(255,255,255,.7)',
                  background: pathname === p.path ? 'rgba(196,30,58,.1)' : 'transparent',
                  transition: 'all .2s',
                  display: 'flex', alignItems: 'center', gap: 8,
                }}
                onMouseEnter={e => { if (pathname !== p.path) { e.currentTarget.style.color = '#c41e3a'; e.currentTarget.style.background = 'rgba(196,30,58,.05)'; } }}
                onMouseLeave={e => { if (pathname !== p.path) { e.currentTarget.style.color = 'rgba(255,255,255,.7)'; e.currentTarget.style.background = 'transparent'; } }}
              >
                {p.label === 'Favorites' && (
